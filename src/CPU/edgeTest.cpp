	...
	double * Gx, double * Gy, int X, int Y)
{
	...
	for (y = 2; y<(Y - 2); y++)
	{
		...
		// if (x + y*X == 298239){
		// 	printf("i: %d modG: %f Ex: %f Ey: %f\n", x + y*X, modG[x + y*X], Ex[x + y*X], Ey[x + y*X]);
		// }
		// if ((x == (X-3)) && (y == (Y-3))){
		// 	printf("i: %d modG: %f Ex: %f Ey: %f\n", x + y*X, modG[x + y*X], Ex[x + y*X], Ey[x + y*X]);
		// }
	...
	uchar * image, uchar * gauss, int X, int Y, double sigma, double th_h, double th_l)
{
	...
	// clock_t end = clock();
	// clock_t timeElapsed = (end - begin) / CLOCKS_PER_MS;
	// std::cout << "Time: " << timeElapsed << "ms\n";

	// std::cout << "************************************************" << std::endl;
	// std::cout << "Devernay curve: " << *curve_limits << std::endl;
	// std::cout << "Devernay x: " << *x << std::endl;
	// std::cout << "Devernay y: " << *y << std::endl;
	// std::cout << "************************************************" << std::endl;
